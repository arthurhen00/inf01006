...
export class GetFilteredPlayersResponse {
  id: number
  player_url: string
  short_name: string
  long_name: string
  ...
  static fromArray(responses: any[]): GetFilteredPlayersResponse[] {
    return responses.map((response) => new GetFilteredPlayersResponse(response))
  }
}
